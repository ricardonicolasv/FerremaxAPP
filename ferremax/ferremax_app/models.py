...
class Inventario(models.Model):
    id_sucursal = models.OneToOneField(Sucursal, on_delete=models.CASCADE, db_column='id_sucursal', primary_key=True)
...
class DetallePedido(models.Model):
    id_pedido = models.OneToOneField(Pedido, on_delete=models.CASCADE, db_column='id_pedido', primary_key=True)
    id_producto = models.ForeignKey(Producto, on_delete=models.CASCADE, db_column='id_producto')
    ...
    class Meta:
        ...
        managed = False  # Important to ensure Django doesn't try to manage this table


class Promocion(models.Model):
    id_producto = models.OneToOneField(Producto, on_delete=models.CASCADE, db_column='id_producto', primary_key=True)
